...
public class BaseDao {
    private static final String URL = "jdbc:mysql://127.0.0.1:3306/schooldb?characterEncoding=utf8&useSSL=false&serverTimezone=Asia/Shanghai&rewriteBatchedStatements=true";
    ...
    private static void setPms(PreparedStatement psmt, Object... params) {
        if (null == psmt) {
            return; //直接终止该方法的运行
        }
    ...
    private static void closeAll(Connection con, Statement stmt, ResultSet rs) {
        try {
            if (null != rs) {
                rs.close();
            }
    ...
    //封装查询
    public static List<Map<String, Object>> select(String sql, Object... obs) {
        Connection con = null;
        PreparedStatement psmt = null;
        ResultSet rs = null;
        con = getCon();
